...
describe('PathfindingReachableFields', () => {
  ...
  test('should work for 76 rows and columns 44 without timeout', () => {
    ...
    [ false,
      ...
      true,
      true ] ];
    const p = new PathfindingReachableFields(inputGrid, 76, 44, 5, 14);
    expect(p.numberOfReachableFields()).toEqual(32);
  });
